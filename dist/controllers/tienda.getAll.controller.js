...
const tienda_services_1 = require("../services/tienda.services"); // Importa el servicio
const getAll = express_1.default.Router();
const tiendaService = new tienda_services_1.TiendaServices();
getAll.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const tiendas = yield tiendaService.getAllTiendas();
        res.json(tiendas);
    }
    catch (error) {
