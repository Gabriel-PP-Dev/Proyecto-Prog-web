...
const getAllProducto_PrecioController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(200).json(producto_Precio.map((precio) => (Object.assign(Object.assign({}, precio), { precio: Number(precio.precio) }))));
    }
    catch (error) {
...
const getProducto_PrecioByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (producto_Precio) {
            res.status(200).json(Object.assign(Object.assign({}, producto_Precio), { precio: Number(producto_Precio.precio) }));
        }
        else {
